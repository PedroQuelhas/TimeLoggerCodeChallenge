...
{ 
    ...
    { 
        ...
        [Route("/api/v1/projects/{id}/timeslots")]
        [ValidateModelState]
        [ProducesResponseType(statusCode: 200, type: typeof(List<TimeslotDTO>))]
        [ProducesResponseType(statusCode: 500, type: typeof(ErrorDTO))]
        ...
        [ProducesResponseType(statusCode: 500, type: typeof(ErrorDTO))]
        public abstract Task<IActionResult> SearchProjects([FromQuery (Name = "offset")][Required()]int offset, [FromQuery (Name = "limit")][Required()]int limit, [FromQuery (Name = "search-key")][Required()]string searchKey, [FromQuery (Name = "search-value")][Required()]string searchValue, [FromQuery (Name = "filter key")]List<string> filterKey, [FromQuery (Name = "filter value")]List<string> filterValue, [FromQuery (Name = "sort-key")]string sortKey, [FromQuery (Name = "sort-order")]string sortOrder);
